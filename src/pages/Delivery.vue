...
export default {
  ...
  methods: {
    ...
    confirmDelivery () {
      this.$store.dispatch("basket/order", { delivery: this.adress, name: this.name, phone: this.cellphone, comment_user: this.commentDelivery, date: this.date, time: this.time, comment: this.comment, payment: this.money, cost: '150' })
        .then(() => {
